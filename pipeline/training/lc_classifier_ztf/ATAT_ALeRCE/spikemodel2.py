...
class SpikeLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        spk, mem1 = self.lif(cur1, mem1) 
        spk = self.dropout(self.out(spk))
        return spk.view(x.size(0),-1)
