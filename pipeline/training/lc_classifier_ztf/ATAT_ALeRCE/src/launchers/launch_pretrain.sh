...
export EXPERIMENT_NAME='20260314_0'
  ...
  ++ATATConfig.lc.use_conv=True\
    ...
    ++ATATConfig.lc.num_encoders=3\
      ++ATATConfig.lc.dropout=0.1\
          ...
          ++ATATConfig.vicreg.var_coeff=1\
          ++ATATConfig.vicreg.cov_coeff=1\
          ++ATATConfig.vicreg.shape_projector_1='128-128-128'\
          ++ATATConfig.vicreg.shape_projector_2='128-128-128'\
