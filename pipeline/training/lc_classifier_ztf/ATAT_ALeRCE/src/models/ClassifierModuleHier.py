...
class ClassifierModuleHier(pl.LightningModule):
    def __init__(self,model,classifier, loss,
                 ...
                 report_mix = False,
                  ...
                  weight_str_parse_tab= 'model.', **kwargs):
        super().__init__()
    ...
    def on_validation_epoch_end(self):
        ...
        if 'LC' in self.modalities:
            plt.title(f"F1-Score: {self.LC_valid_metrics['f1'].compute().item()}")
    ...
    def configure_optimizers(self):
        ...
        optimizer =optimizer = optim.AdamW(self.parameters(),   
                                lr = self.learning_rate, weight_decay = 0.1)
    ...
    def init_metrics(self,report_lc, report_tab, report_mix):
        metrics = torchmetrics.MetricCollection({
            ...
            'precision': torchmetrics.classification.Precision(task="multiclass", num_classes=22, average="macro"),
            })
